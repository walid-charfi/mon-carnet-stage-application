...
export class StageRadiologieUpdateComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.activatedRoute.data.subscribe(({ stageRadiologie }) => {
      if (stageRadiologie.id === undefined) {
        ...
        stageRadiologie.dateDebut = today;
        stageRadiologie.dateFin = today;
  ...
  protected updateForm(stageRadiologie: IStageRadiologie): void {
    this.editForm.patchValue({
      ...
      dateDebut: stageRadiologie.dateDebut ? stageRadiologie.dateDebut.format(DATE_TIME_FORMAT) : null,
      dateFin: stageRadiologie.dateFin ? stageRadiologie.dateFin.format(DATE_TIME_FORMAT) : null,
      ...
      specialite: stageRadiologie.specialite,
