  ...
  describe('StageRadiologie Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = {
        ...
        semestre: 'AAAAAAA',
        groupe: 'AAAAAAA',
        evaluationObjectif1Etudiant: EvaluationEtudiant.NoDemo,
        noteObjectif1EncadrantReferent: NoteEncadrantReferent.NonAcquis,
      };
    });
    ...
    describe('Service methods', () => {
        ...
        const returnedFromService = Object.assign(
          {
            ...
            semestre: 'BBBBBB',
            groupe: 'BBBBBB',
            evaluationObjectif1Etudiant: 'BBBBBB',
            noteObjectif1EncadrantReferent: 'BBBBBB',
          },
          elemDefault
        );
      ...
      describe('addStageRadiologieToCollectionIfMissing', () => {
        ...
        it('should add only unique StageRadiologie to an array', () => {
          const stageRadiologieArray: IStageRadiologie[] = [{ id: 123 }, { id: 456 }, { id: 42923 }];
