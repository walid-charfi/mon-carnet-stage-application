...
export class StageRadiologieService {
  ...
  protected convertDateFromClient(stageRadiologie: IStageRadiologie): IStageRadiologie {
    return Object.assign({}, stageRadiologie, {
      dateDebut: stageRadiologie.dateDebut?.isValid() ? stageRadiologie.dateDebut.toJSON() : undefined,
      dateFin: stageRadiologie.dateFin?.isValid() ? stageRadiologie.dateFin.toJSON() : undefined,
